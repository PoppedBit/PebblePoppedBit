...
#define MESSAGE_LAYER_HEIGHT 25
...
static void inbox_received_callback(DictionaryIterator *iterator, void *context)
{
    ...
    // Note: MESSAGE_KEY_MessageCount is auto-generated by Pebble SDK from appinfo.json appKeys
...
static void main_window_load(Window *window)
{
    ...
    s_message_layer = text_layer_create(
        GRect(0, bounds.size.h - MESSAGE_LAYER_HEIGHT, bounds.size.w, MESSAGE_LAYER_HEIGHT));
